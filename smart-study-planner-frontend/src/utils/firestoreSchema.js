...
// ── COLLECTION: tasks ────────────────────────────────────────────────────────
//
// Document ID: task_<categorySlug>_<titleSlug>_<NNN>
//   Generated by generateTaskId() in firestoreIds.js
//   where categorySlug = slugify(category name)  e.g. "Math & Science" → "math-science"
//         titleSlug    = slugify(task title)      e.g. "Unity Notes"    → "unity-notes"
//         NNN          = zero-padded 3-digit sequential counter (001, 002, …)
//
// Examples:
//   task_school_unity-notes_001
...
//
// Uniqueness guarantee:
//   Sequential counter is scanned from existing docs at write time.  A
//   collision check loop retries if a concurrent write races ahead.  See
//   generateTaskId() in firestoreIds.js for the full algorithm.
//
