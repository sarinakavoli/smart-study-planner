...
//   readableId    string   Same as document ID — stored for easy debugging
...
//   shortUserId = first 6 chars of Firebase Auth UID
//   random4     = 4 lowercase alphanumeric characters
...
//      a. Generate resolvedOrgId = personalOrgId(uid, email)
//              = "org_" + uid.slice(0, 6) + "_" + slugify(email.split("@")[0])
//      b. Create organizations/<resolvedOrgId> with id, readableId, name, ownerId,
